...
Algoritmo ciclista
	Definir dias, h1, h2, m1, m2, s1, s2  Como Entero
	
	Escribir "Ingrese la hora de salida, luego minutos y luego segundos"
	Leer h1,m1,s1
	Escribir "Cuanto tardo en llegar? (d:h:m:s)"
	Leer dias,h2,m2,s2
	...
	Si (dias = 1)
		Escribir "Llego en ",dias," día, a las ",h2 ,":",m2,":", s2
	SiNo
		Si (dias > 1)
			Escribir "Llego en ",dias," días, a las ",h2 ,":",m2,":", s2
		SiNo
			Escribir "Llego a las ",h2 ,":",m2,":", s2
		FinSi
	FinSi
