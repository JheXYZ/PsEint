...
Algoritmo notas_v2
	...
	SiNo
		Escribir "Ningún alumno tiene promedio menor a 6.5 en el parcial"
	FinSi
	
	
	Escribir "El porcentaje de alumnos aprobados en el integrador con 7.5 o más ", (Integrador*100)/n, "%"
